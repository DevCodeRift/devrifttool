-- Fix multiplayer battle schema
-- This script will drop and recreate tables in the correct order
...
-- Drop any old table structures that might conflict
...
-- Now recreate tables in correct order

-- 1. Battle rooms (parent table)
...
-- 2. Battle room players (references battle_rooms.id)
...
-- 3. Battle actions (references battle_rooms.id)
...
-- 4. Battle logs (references battle_rooms.id)
